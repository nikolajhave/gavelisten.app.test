...
test('danish translations are returned for key ui strings and pluralization', function () {
    ...
    expect(__('My Wishlist'))->toBe('Min ønskeliste')
        ...
        ->and(__('See Public Wishlist'))->toBe('Se offentlig ønskeliste')
        ->and(__('Anyone with this link can view your wishlist and reserve items.'))->toBe('Enhver med dette link kan se din ønskeliste og reservere ønsker.')
...
test('english translations are preserved and returned when locale is english', function () {
    ...
    expect(__('My Wishlist'))->toBe('My Wishlist')
        ...
        ->and(__('See Public Wishlist'))->toBe('See Public Wishlist')
        ->and(__('Anyone with this link can view your wishlist and reserve items.'))->toBe('Anyone with this link can view your wishlist and reserve items.')
